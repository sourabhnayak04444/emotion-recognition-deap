...
📂 Folder StructureThe output is saved in ./spectrograms_output/ as follows:Subject ID (e.g., s01)Valence $\rightarrow$ HV (High) / LV (Low)Arousal $\rightarrow$ HA (High) / LA (Low)
